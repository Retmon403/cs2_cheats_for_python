...
if __name__ == '__main__':
    ...
    def Menu():
        imgui.set_next_window_size(400, 280, imgui.FIRST_USE_EVER)
        imgui.begin('python cs2 cheats[lyx]', True)

        imgui.text("ESPBons greatly affect operational efficiency!")
        imgui.separator()
        ...
        imgui.same_line()
        UI_MENU.exclude_teammates = imgui.checkbox(
            'ExcludeTeammates', UI_MENU.exclude_teammates)[1]
