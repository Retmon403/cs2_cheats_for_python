...
class Hacker(Pymem):
    ...
    def update_offset(self) -> bool:
        ...
        try:
            ...
            print('dwEntityList:', hex(Offset.dwEntityList), 'dwLocalPlayerController:', hex(
                Offset.dwLocalPlayerController), 'dwViewMatrix:', hex(Offset.dwViewMatrix), 'dwViewAngles:', hex(Offset.dwViewAngles), 'dwViewAngles_Add:', hex(Offset.dwViewAngles_Add))
    ...
    def get_jump_status(self) -> bool:
        return self.mem.read_ulong(self.client+Offset.dwForceJump) == 65537
