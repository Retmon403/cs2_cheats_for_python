...
class MyImGui:
    ...
    def __init__(self, window_w: int = 550, window_h: int = 450, resizable: bool = True,
                 create_ini_file: bool = False) -> None:
        self.window = pyglet.window.Window(width=window_w, height=window_h, resizable=resizable,
